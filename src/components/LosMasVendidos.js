...
const LosMasVendidos = function () {
	...
	return (
		<section id="losmasvendidos" className={css.losmasvendidos}>
			...
			{ladata ? <Productos cantidad="5" info={ladata} /> : (<img className="loading" style={{ width: "100px", margin: "0 auto", display: "block" }} src="/assets/images/loading.webp" alt="Cargando ..." />)}
		</section>
	);
};
